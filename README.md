# GetBible Package (v4.0.15-beta1)
...
- [getBible/joomla-component](https://git.vdm.robot/getBible/joomla-component) [4.x](https://git.vdm.robot/getBible/joomla-component/archive/4.x.zip)
> 4.x
